    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-gray-700">
        ...
        <div className="flex items-center gap-1 shrink-0">
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-1 z-20 w-60 max-h-72 overflow-auto bg-gray-800 border border-gray-600 rounded-xl p-2 shadow-2xl">
                    ...
                    {allFields.map((f) => (
                      <label
                        key={f.key}
                        className="flex items-center gap-2 px-2 py-1.5 text-sm text-gray-100 hover:bg-gray-700 rounded-lg cursor-pointer"
                      >
                        <input
                          type="checkbox"
                        ...
                        {f.key.startsWith("cf:") && (
                          <span className="text-[10px] bg-blue-600/20 text-blue-300 px-1.5 py-0.5 rounded ml-auto shrink-0">
                            Excel
                          </span>
                        )}
                      </label>
          ...
          <Badge className="bg-blue-500/20 text-blue-400">{badgeLabel}</Badge>
        </div>
      </div>
